...
#
# Parameters:
#	gsea.list: a list of GSEA objects.
#	patterns: a vector of patterns which should be unique enough to find just one cluster
#
# Value:
...
##' 
##' Scenario:
##' you've used gsea.split to split a LARGE GSEA run into ~100 smaller, related
