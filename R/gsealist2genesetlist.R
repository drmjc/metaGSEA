...
#
# From a list of GSEA objects (like what you get from gsea.split), extract the geneset names, and create a gmx-like object. i.e. a table where each column contains a vector of geneset names mentioned in each of the GSEA objects in the list.
#
# Parameters:
#	x: a list of GSEA objects
#
# Value:
#	a data.frame with colnames == names(x), no rownames, where each column contains the genesets which were in the relevant object inside x.
#
